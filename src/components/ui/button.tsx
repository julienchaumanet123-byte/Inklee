...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
          "bg-gold text-ink-950 hover:bg-gold-300 shadow-lg shadow-gold/20 hover:shadow-gold/30",
        destructive:
          "bg-destructive text-destructive-foreground hover:bg-destructive/90",
        outline:
          "border border-ink-700 bg-transparent hover:bg-ink-800 hover:text-foreground",
        secondary:
          "bg-ink-800 text-foreground hover:bg-ink-700",
        ghost: "hover:bg-ink-800 hover:text-foreground",
